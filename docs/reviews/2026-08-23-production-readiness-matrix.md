...
**Current verified code head:** `7a73bc0fa9751c67d2d383b2a00daa02288f8c3b`

**Managed production current:** `7a73bc0fa9751c67d2d383b2a00daa02288f8c3b`
**Managed production previous:** `901dc9a60aa5747170032e7ddd1f6f304ffbf885`
...
| Supervisor restart/rollback | **LIVE для managed release** | Target unit использует managed `active/current`; explicit restart и цикл `7a73bc0→901dc9a→7a73bc0` завершены, финальный service active и `NRestarts=0` | Повторять тот же gate для каждого следующего release |
| Managed Git install/update/rollback | **LIVE: target cutover принят** | Public disposable corpus дополнен controlled fr1 cutover: current=`7a73bc0`, previous=`901dc9a`, full Doctor green после roll-forward; unit rollback-файл сохраняет прежний source ExecStart | Operator-level Telegram E2E и следующий release cycle |
...
- Node 22 full corpus: Core **2357 passed / 1 skipped**, App **2540 passed /
  19 skipped**, Telegram Gateway **255 passed**;
