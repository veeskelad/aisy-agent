...
**Status:** Proposed (partly superseded by [ADR-0061](./2026-07-26-demonstration-grounded-autonomy-promotion.md))
**Date:** 2026-06-11
**Tags:** security

> **Partially superseded by ADR-0061 (2026-07-26):** the deterministic risk
> tiers and non-bypassable Tier-3 gate remain. The single global autonomy level
> is no longer the only control; evidence-grounded project/tool/resource grants
> provide learned, scoped autonomy.
