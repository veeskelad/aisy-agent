...
- **Status:** Accepted for npm channel; production-primary часть заменена [ADR-0106](./2026-08-22-managed-git-distribution-without-apt.md)
- **Date:** 2026-06-24
...
> Исторически npm был выбран primary channel для 0.1.0. После ADR-0106 npm
> остаётся дополнительным каналом, а канонический production install использует
> managed Git.
