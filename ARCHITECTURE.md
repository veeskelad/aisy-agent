...
The harness decomposes into seventeen components, each with its own spec in
`docs/specs/`:
...
| 13 | Onboarding & Operations | install, init, doctor, service lifecycle, upgrades |
| 14 | Triggers & Proactivity | schedules, monitors, proactive jobs, pause/approval controls |
| 15 | Context Engine | lease-bound transcript projection, compaction-as-view, cache breakpoints |
| 16 | Brain Connections & Telegram Bootstrap | bot-first setup, provider subscriptions/API connections |
| 17 | Projects, Sessions, Context & Files | Workspace/Project ownership, switching, sessions, scoped files/memory |
