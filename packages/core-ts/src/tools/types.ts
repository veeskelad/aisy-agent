...
import type { RuntimeToolName } from '../runtime/tool-catalog.js'

// Compat types are aliases of the one live catalog, never an independent waist.
export type BaseToolName = RuntimeToolName
